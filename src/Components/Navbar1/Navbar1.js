...
<div className=" mx-2 text-white  font-semibold flex justify-center items-center text-center"><box-icon name='mail-send' color='white' animation='flashing' flip='horizontal' ></box-icon><a className="text-base  mx-1.5" href="mailto:recipient@example.com">kaews@gmail.com</a></div>
    ...
    <div className="flex">
    <i class='bx bxl-instagram text-[26px] px-3 text-white  hover:text-black   p-2 ' ></i>            
    <i class='bx bxl-twitter text-[26px] px-3 text-white  hover:text-black   p-2 ' ></i>            
            <i class='bx bxl-wordpress text-[26px] px-3 text-white  hover:text-black   p-2 ' ></i>            
            <i class='bx bxl-linkedin text-[26px] px-3 text-white  hover:text-black   p-2 ' ></i>            
