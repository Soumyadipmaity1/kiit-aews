...
export default function GuildingPillars() {
    return (
        <div class="bg-white   m-4 w-80 p-4  text-justify  border-2 border-blue-900 hover:border-2  hover:border-indigo-500  rounded-2xl my-20 transform hover:scale-100 transition-transform duration-500">
